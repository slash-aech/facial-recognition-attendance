...
export default function TimetableViewer() {
  ...
  const handleFetch = () => {
    if (selectedInstitute && selectedAcademicYear && selectedDepartment && selectedType && selectedEntity) {
  ...
  return (
    <div className="mainContent">
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
        <select required value={selectedInstitute} onChange={e => setSelectedInstitute(e.target.value)}>
        ...
        <select required value={selectedDepartment} onChange={e => setSelectedDepartment(e.target.value)}>
